	...
	<div id="main_b">
		<div class="wrapper">
			...
			<div class="social-icon">';
				...
				echo '
		                     <a href="', $settings['facebook_url'] , '"><span class="icon-facebook"></span></a>';

				if(!empty($settings['twitter_url']))
				echo '
		                     <a href="', $settings['twitter_url'] , '"><span class="icon-twitter"></span></a>';

				if(!empty($settings['rss_url']))
				echo '
		                     <a href="', $settings['rss_url'] , '"><span class="icon-rss"></span></a>';
...
function template_body_below()
{
	...
	<div class="wrapper">
		<ul class="reset">
			<li class="copyright">', theme_copyright(), ' | <strong>Concept</strong> by Mick. G</li>
